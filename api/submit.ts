...
export default async function handler(req: any, res: any) {
  ...
  const record = {
    ...
    day_1_hours: toNum(fields["Day 1 Hours"]), day_1_rate: toNum(fields["Day 1 Rate (ZAR)"]), day_1_date: fields["Day 1 Date"] || null,
    day_2_hours: toNum(fields["Day 2 Hours"]), day_2_rate: toNum(fields["Day 2 Rate (ZAR)"]), day_2_date: fields["Day 2 Date"] || null,
    day_3_hours: toNum(fields["Day 3 Hours"]), day_3_rate: toNum(fields["Day 3 Rate (ZAR)"]), day_3_date: fields["Day 3 Date"] || null,
    day_4_hours: toNum(fields["Day 4 Hours"]), day_4_rate: toNum(fields["Day 4 Rate (ZAR)"]), day_4_date: fields["Day 4 Date"] || null,
    day_5_hours: toNum(fields["Day 5 Hours"]), day_5_rate: toNum(fields["Day 5 Rate (ZAR)"]), day_5_date: fields["Day 5 Date"] || null,
    day_6_hours: toNum(fields["Day 6 Hours"]), day_6_rate: toNum(fields["Day 6 Rate (ZAR)"]), day_6_date: fields["Day 6 Date"] || null,
    day_7_hours: toNum(fields["Day 7 Hours"]), day_7_rate: toNum(fields["Day 7 Rate (ZAR)"]), day_7_date: fields["Day 7 Date"] || null,
