    ...
    <div className="bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-12 gap-10 border-b border-white/10">
        <div className="md:col-span-7 grid grid-cols-2 gap-4 relative">
          <img src={images.about.aboutUs3} alt="Brand hostess at premium activation" className="w-full aspect-[3/4] object-cover" loading="lazy" decoding="async" />
          <img src={images.about.elAlta} alt="Elegant promoter at luxury event" className="w-full aspect-[3/4] object-cover mt-12" loading="lazy" decoding="async" />
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-7 grid grid-cols-2 gap-4">
          <img src={images.about.img8975} alt="Corporate brand experience" className="w-full aspect-square object-cover" loading="lazy" decoding="async" />
          <img src={images.about.img1403} alt="" className="w-full aspect-square object-cover" loading="lazy" decoding="async" />
          <img src={images.about.activation} alt="Event activation" className="col-span-2 w-full aspect-[16/9] object-cover" loading="lazy" decoding="async" />
        </div>
        <div className="md:col-span-5 border border-white/15 p-8 md:p-10">
          ...
          <p className="text-white/85 leading-relaxed">
            Our mission is to deliver exceptional, high impact brand experiences through strategic insight, world class staffing and meticulous execution. We translate brand ambition into immersive moments that captivate audiences, elevate brand presence4 and produce measurable results at every touchpoint.
          </p>
        </div>
      </section>
    </div>
